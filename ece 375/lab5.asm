...
;*
;*	Adding two 16-bit numbers and squaring the result.
;*
...
ADD16:
		...
		ld A, X ; load the contents of the register X is pointing to into A.
		ld B, Y ; load the contents of the register X is pointing to into A.
